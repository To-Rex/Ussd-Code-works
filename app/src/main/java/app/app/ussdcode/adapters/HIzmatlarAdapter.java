...
public class HIzmatlarAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (status.equals("Usell")) {
            txthizadaptername.setTextColor(context.getResources().getColor(R.color.purple_500));
        }
        ...
        listitemView.setOnClickListener(v -> {
            ...
            if (dataModal.getStatus().equals("Usell")) {
                btndiulan.setTextColor(context.getResources().getColor(R.color.purple_500));
                btndibatafsil.setTextColor(context.getResources().getColor(R.color.purple_500));
                btndiorqa.setTextColor(context.getResources().getColor(R.color.purple_500));
            }
